...
SMA.prototype.readProperties = function () {
  ...
  Promise.all([
    ...
    console.info('readProperties results', results)
    ...
    console.info('self.deviceType', self.deviceType)
    console.info('self.modbusSettings', self.modbusSettings)
    readModbus(self, inverterType.getInfoRegistries(self.modbusSettings))
      .then((result) => {
        ...
        console.info('getInfoRegistries properties', properties)
